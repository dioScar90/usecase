...
const Review = ({ imgSrc, className, ...props }: ReviewProps) => {
  ...
  return (
    <div className={cn('animate-fade-in rounded-[2.25rem] bg-white p-6 opacity-0 shadow-xl shadow-slate-900/5', className)} style={{ animationDelay } as CSSProperties} {...props}>
      <Phone imgSrc={imgSrc} />
    </div>
  )
}
...
const ReviewColumn = ({
  ...
  return (
    <div ref={columnRef} className={cn('animate-marquee space-y-8 py-4', className)} style={{'--marquee-duration': duration} as CSSProperties}>
