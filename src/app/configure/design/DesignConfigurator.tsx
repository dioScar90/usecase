...
const DesignConfigurator = ({
  ...
  function base64ToBlob(base64: string, mimeType: string) {
    // 'atob' is deprecated, so there might be another ways to do that.
    // But it works, so that's fine for now.
    // Maybe in the future we could refact this piece of code. Perhaps.
  ...
  async function saveConfiguration() {
    try {
      ...
      // 'filename.png' doesn't matter at all because 'uploadthing' will automatically create a new file name.
